...
local H_SPLIT_PEN = dfhack.pen.parse{tile=curry(gui.tp_border_thin, 6), ch=196, fg=COLOR_GREY, bg=COLOR_BLACK}
local V_SPLIT_PEN = dfhack.pen.parse{tile=curry(gui.tp_border_thin, 5), ch=179, fg=COLOR_GREY, bg=COLOR_BLACK}
local TOP_SPLIT_PEN = dfhack.pen.parse{tile=curry(gui.tp_border_window,2), ch=209, fg=COLOR_GREY, bg=COLOR_BLACK}
local BOTTOM_SPLIT_PEN = dfhack.pen.parse{tile=curry(gui.tp_border_window,16), ch=207, fg=COLOR_GREY, bg=COLOR_BLACK}
local LEFT_SPLIT_PEN = dfhack.pen.parse{tile=curry(gui.tp_border_window,8), ch=199, fg=COLOR_GREY, bg=COLOR_BLACK}
local RIGHT_SPLIT_PEN = dfhack.pen.parse{tile=curry(gui.tp_border_thin, 18), ch=180, fg=COLOR_GREY, bg=COLOR_BLACK}
